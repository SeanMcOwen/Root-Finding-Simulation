...
## State<h3>Local States</h3><h2>Spaces</h2><h3>Terminating Space</h3><p>{}</p><h3>Computation Time Metric Space</h3><p>{simulation_time: datetime,<br/>computation_time: Seconds Type,<br/>action_name: str}</p><h3>Update X Space</h3><p>{x: X Type}</p><h3>Empty Space</h3><p>{}</p><h3>Update Y Prime Space</h3><p>{y_prime: Objective Derivative Value Type}</p><h3>Update Y Space</h3><p>{y: Objective Value Type}</p><h2>Behavioral Action Space</h2><h2>Control Action Space</h2><h3>Initialization Control Action</h3><p>Control action to begin the simulation</p><h4>Constraints:</h4>
...
<h4>Constraints:</h4>
<h4>Logic:</h4>
<p></p><h2>Parameters</h2><p>max_iterations</p><p>root_finding_method</p><p>f</p><p>f_prime</p>